...
//For In loop. (i) contains only the index number.
// for(let i in products)
// {
//     console.log(products[i].title)
// }

//For Of loop. (i) contains only the index value.
...
//In a For Each loop you can only iterate the value in the array. But in the map you can iterate and return the value to a particular variable.
// let data = products.map((e)=>
// {
//     console.log(e.title)
//     return `The product ${e.title} costs ${e.price}`
// })

// console.log(data)

//In the map concept, we manually return the data. But in the filter, filter itself returns the data automatically.
//Filter the product whose price are less than 500
// let filterdata = products.filter((e)=>e.price<500)
// console.log(filterdata)


//Filter the product whose price is less than 500
...
// let b = [100,200,300]
// a.push(...b)// ... it seperates the value as comma seperated in the array
// console.log(a)

// a.shift()//Removes the value at the begining
// console.log(a)
// a.unshift(...b)//Insert the values at the begining
// console.log(a)

// //slice always gives you a new array. It never modify the actual array
// let out1 = a.slice(3)//Provides the new array from the start of the index
// console.log(out1)
// let out2 = a.slice(3,7)//Provides the values between this index
// console.log(out2)
//

//Splice function alternates the original array. This function can perform the CRUD operation
// let a = [1,2,3,4,5,6,7,8,9]
// console.log(a)
// a.splice(3)//It only prints the value from 1 to 3. Other remaining elements are deleted
// console.log(a)
// a.splice(3,1)//At the 3 index removes the 1 element.
// console.log(a)
// a.splice(3,1,4)//At the third index it removes one element and add the element 4 in that position.
// console.log(a)

// let a = [10,100,200,50,30,10]
// a.sort()// If we give the normal sort function it computes the value in the string format so that in the unicode format. 
// // They end up being sorting the element in the dict or lexicographical order.
// console.log(a)
